...
+ (NSData *)dataFromBase64String:(NSString *)aString
{
	...
	size_t outputLength;
	void *outputBuffer = CWLNewBase64Decode([data bytes], [data length], &outputLength);
...
- (NSString *)base64EncodedString
{
	size_t outputLength;
	char *outputBuffer =
		CWLNewBase64Encode([self bytes], [self length], true, &outputLength);
